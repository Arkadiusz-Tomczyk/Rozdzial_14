...
public class TrelloClient {
    ...
    private URI getUri() {
        return UriComponentsBuilder.fromHttpUrl("https://api.trello.com/1" + "/members/"
                + "arkadiusztomczyk1" + "/boards")
                .queryParam("key", "e26ccab07b611f3e7db4761de96c117c")
                .queryParam("token", "c91579056c72cf5500836c63ac3c8d9f24699248bba31ba4cfd0fb79511adace")
